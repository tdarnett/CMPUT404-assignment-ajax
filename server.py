...
def hello():
    ...
    # from Flask API docs - http://flask.pocoo.org/docs/0.12/api/#flask.redirect and http://flask.pocoo.org/docs/0.12/quickstart/#url-building accessed March 4, 2017
